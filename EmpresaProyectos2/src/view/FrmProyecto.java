 ...
 * 
 * @author Carmen
 * mostramos la ventana proyecto cuando han seleccionado en la ventana principal el menu proyecto
 */
	...
	public FrmProyecto() {	
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				controller.CtrlProyectos.mostrarNuevo();
			}
		});
		...
		btnInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.CtrlProyectos.editarProyectoInfo();
